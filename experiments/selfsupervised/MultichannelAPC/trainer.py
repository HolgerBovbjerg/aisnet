    ...
    def validate(self):
        ...
        with torch.no_grad():
            ...
            for batch_idx, data in enumerate(self.val_loader):
                ...
                # Compute loss
                loss = torch.tensor(10.)  # self.criterion(predictions, targets)
...
def setup_trainer(config, model, train_loader, val_loader, label_mapping):
    return ExampleTrainer(config, model, train_loader, val_loader, label_mapping)
