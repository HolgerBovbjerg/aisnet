...
class AdditiveMarginSoftmax(nn.Module):
    def __init__(self, n_out, n_classes, margin=0.3, scale=15, **kwargs):
        super().__init__()
...
class AdditiveAngularMarginSoftmax(nn.Module):
    def __init__(self, n_out, n_classes, margin=0.35, scale=30, easy_margin=False, **kwargs):
        super().__init__()
